...
// 에러 발생
// Cannot assign to property: 'publicGetOnlyStoredProperty' setter is inaccessible
...
// 에러 발생
//Cannot assign to property: 'internalGetOnlyComputedProperty' setter is inaccessible
...
// 외부에서 접근자지만, 같은 모듈내에서는 설정자도 사용 가능
